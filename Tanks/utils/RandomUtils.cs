...
namespace Tanks.utils
{
    public static partial class Utils
    {
        ...
        /// </summary>
        public static float RangeF(this Random r, float min, float max)
        {
        ...
        /// </summary>
        public static float RandomAngleF(this Random random)
        {
            return random.RangeF(0, RadiansPerRotation);
        }
    }
}